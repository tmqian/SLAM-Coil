...
if plot.lower() == "y":
    coils, axis_path = get_coil_info(
        filename[1:], interpolate=False, L=Mirror_Length, R=Stellerator_Radius
    )
    ...
    # col2 = right panels
    gs = GridSpec(
        2, 3, figure=fig, width_ratios=[1.5, 0.05, 1.0], height_ratios=[1.0, 1.0]
    )
